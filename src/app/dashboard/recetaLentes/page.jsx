...
export default function RecetaLentesPage() {
    ...
    function generarPDF() {
        ...
        try {
            ...
            doc.setFontSize(7);
            doc.setTextColor(...muted);
            doc.text("Generated by AgendaClinica | Healthcare Information System", margin + 6, pageH - 11);
            doc.text("Clinical use", pageW - margin - 6, pageH - 11, {align: "right"});
                    ...
                    <div className="space-y-6">
                        <div className="overflow-hidden rounded-[28px] border border-slate-200 bg-white shadow-sm">
                            ...
                            <div className="bg-[#f8fafc] p-4 md:p-6">
                                <div className="mx-auto rounded-[26px] border border-slate-200 bg-white p-6 shadow-sm">
